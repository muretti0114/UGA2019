...
def check_internet():
    ...
    try:
        ...
        print("Internet is unreacheable")
    return False
...
secrets_filename = 'secret_key'
api_keys = {}
with open(secrets_filename, 'r') as f:
    api_keys = json.loads(f.read())

api_key = api_keys['SECRET']
...
liste14.select_set(0)

label = Label(fenetre, text="Student School attended Class X")
...
liste16.select_set(0)

label = Label(fenetre, text="Class attendance Percentage")
